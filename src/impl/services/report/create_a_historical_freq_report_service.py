...
class CreateAHistoricalFreqReportService:
    ...
    def preprocess_request_data(self):
        ...
        try:
            ...
            try:
                ...
                historical_freq_data = report_repository.create_historical_freq_report(
                    user_id=user_id,
                ...
                self.preprocessed_data = historical_freq_data
